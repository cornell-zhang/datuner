...
def runVPR(run_abc_cmd, run_vpr_cmd, abc_config, vpr_config, design, rank, reqid, res, requestor):
  ...
  start = time.time()
  exptype='EXPTYPE'
  bdir='/proj/xsjhdstaff3/changx/project/parTuner/experiment/vpr/vtr_release/vtr_flow/'
  sdir = bdir+'scripts/'
...
class VPRTuner(MeasurementInterface):
  ...
  def manipulator(self):
    ...
    bench='BENCH_HOLDER'
    exptype='EXPTYPE'
    filename="/proj/xsjhdstaff3/changx/project/parTuner/experiment/vpr/vtr_release/vtr_flow/tasks/openTunerTiming/experiment/"+exptype+"/"+bench+"/space"+str(self.args.rank)+".txt"
  ...
  def run(self, desired_result, input, limit):
    ...
    design = "BENCH_HOLDER"
    #basedir = '/proj/xsjhdstaff3/changx/project/parTuner/experiment/vpr/'
    #workdir = basedir+'/'+design+'/rank'+str(self.args.rank)+'/'
