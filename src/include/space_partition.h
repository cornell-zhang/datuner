...
void param_entropy(std::map<int,std::vector<Result*> >points, Space*, Space*, std::vector<std::string>&);
...
void divide_space(int, Space*, std::map<int,std::vector<Result*> >&, std::map<int,Result*>&, std::map<int,Space*>&, int&, int&);
