...
#
# Usage:
#	run_vtr_flow.pl <perl_libs> <circuit_file> <architecture_file> [OPTIONS]
#
# Parameters:
#   perl_libs: 
...
if ( $number_arguments < 3 ) {
	print(
		"usage: run_vtr_flow.pl <vtr_flow> <perl_libs> <circuit_file> <architecture_file> [OPTIONS]\n"
	);
	exit(-1);
}

my $vtr_flow_path = expand_user_path( shift(@ARGV) );
#my $perl_libs_path = expand_user_path( shift(@ARGV) );

#my $perl_libs_path = expand_user_path( shift(@ARGV) );

use lib "/home/xuchang/nas/project/daTuner/myrelease/pkgs/vtr/vtr_release/vtr_flow/scripts/perl_libs/XML-TreePP-0.41/lib";
#use lib expand_user_path( shift(@ARGV) );
#use lib "$perl_libs_path";
#use lib "$perl_libs_path/perl_libs/XML-TreePP-0.41/lib";
use XML::TreePP;

# Get Absoluate Path of 'vtr_flow
Cwd::abs_path($0) =~ m/(.*\/vtr_flow)\//;
#my $vtr_flow_path = $1;
#my $vtr_flow_path = "/home/xuchang/nas/project/daTuner/myrelease/pkgs/vtr/vtr_release/vtr_flow";
print("\n");
print($vtr_flow_path);
print("\n");
