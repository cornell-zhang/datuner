...
class VTRTuner(MeasurementInterface):
  ...
  def runvtr(self,run_abc_cmd, run_vtr_cmd, abc_config, vtr_config, reqid, res, requestor):
    ...
    #run_abc_cmd = ""
    cmd = 'sed -e \'s:ABC_OTHER_OPTIONS:'+run_abc_cmd+':g\' -e \'s:VPR_OTHER_OPTIONS:'+run_vtr_cmd+':g\' -e \'s:VTRFlowPath_Holder:'+self.vtrpath+':g\' '+self.scriptpath+'/eda_flows/vtr/run_vtr_flow.pl > '+workdir+'run_vtr_flow_'+str(self.args.rank)+'.pl'
