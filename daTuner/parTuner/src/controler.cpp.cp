...
int main(int argc, char** argv){
  ...
  string tmp_whole = "-whole";
  string tmp_restart = "-restart";
  string tmp_exp1 = "-exp-fix";
  ...
  map<int,vector<Result*> > points; //result 
  ...
  if(vpr_flag && exp_fix_MAB) {limit=40; round =3;} //CHECK!!!!!

  if(vpr_flag && exp_fix) {limit=30; round = 5;}
  while(iter < round) {
