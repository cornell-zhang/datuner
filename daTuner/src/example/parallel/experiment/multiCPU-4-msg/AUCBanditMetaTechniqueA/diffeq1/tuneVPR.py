...
def runVPR(run_abc_cmd, run_vpr_cmd,exptype, tech, design, rank, reqid, res, requestor):
  ...
  #replace with your own workspace
  tdir= '/work/zhang/users/chang/project/daTuner/opentuner/example/parallel/experiment/'
  #tdir= '/work/zhang/users/chang/project/daTuner/apps/vtr/experiment/' #path-to-workspace
