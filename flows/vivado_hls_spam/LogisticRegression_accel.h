...
#endif
#ifdef HW
    typedef ap_fixed<TOT_WIDTH_FEATURE,INT_WIDTH_FEATURE> FeatureType;
    typedef ap_fixed<16,4> DataType;
    typedef ap_uint<64> DataType2;
    typedef ap_uint<INT_WIDTH_LABEL> LabelType;
    typedef ap_uint<8> LabelType2;
    typedef ap_ufixed<TOT_WIDTH_TMP,INT_WIDTH_TMP> TmpFixed; 
