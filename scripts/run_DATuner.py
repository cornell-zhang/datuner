...
design_name = 'DESIGN_NAME_HOLD'                                                      #
design_path = 'DESIGN_PATH_HOLD'
top_module = 'TOP_MODULE_HOLD'
space_def = 'SPACE_DEF_HOLD'
py_code = 'PYTHON_CODE_HOLD'
work_space = 'WORK_SPACE_HOLD'                                   #
proc_num = 'PROC_NUM_HOLD'                                                                #
datuner_path = 'DATUNER_PATH_HOLD'            #
objective = 'OBJECTIVE_HOLD'
modify_cst = 'MODIFY_CST_HOLD'
cst_value = 'CST_VALUE_HOLD'       #default 4.5
