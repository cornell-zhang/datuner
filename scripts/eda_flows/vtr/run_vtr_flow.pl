...
use lib "VTRFlowPath_Holder/scripts/perl_libs/XML-TreePP-0.41/lib";
use XML::TreePP;
...
my $vtr_flow_path = "VTRFlowPath_Holder";
	...
	and !$error_code )
{
	$q = &system_with_timeout( $abc_path, "abc.out", $timeout, $temp_dir, "-c",
		"read $odin_output_file_name; time; resyn; resyn2; ABC_OTHER_OPTIONS; if -K $lut_size; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; scleanup; time; write_hie $odin_output_file_name $abc_output_file_name; print_stats"
	);
