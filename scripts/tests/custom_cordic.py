...
py_code = '/work/zhang/users/liu/datuner/releases/Linux_x86_64/scripts/eda_flows/cordic/tunefp.py'
design_path = '/work/zhang/users/liu/datuner/releases/Linux_x86_64/scripts/eda_flows/cordic'
