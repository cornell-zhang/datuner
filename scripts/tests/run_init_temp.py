...
run_cmd = "python "+ pwd + "/releases/Linux_x86_64/scripts/datuner_new.py -f vtr -t 20 2 0 0.2197 -p 2 -b 1"
print "call: python ./datuner_new.py -f vtr -t 20 2 0 0.2197 -p 2 -b 1"  
os.system(run_cmd)
